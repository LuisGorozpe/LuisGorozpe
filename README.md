<div align="center">
  ...
  *Bridging the gap between rigorous mathematical theory and industrial data solutions.*
  ...
  [![Personal Page](https://img.shields.io/badge/Portfolio-al--folio-blue?style=for-the-badge&logo=google-cloud)](https://luisgorozpe.github.io/al-folio/)
...
I am a **PhD Candidate in Probability and Statistics** at [CIMAT](https://www.cimat.mx) with over 7 years of training in mathematical modeling. My expertise lies in translating complex theoretical concepts into robust, scalable software solutions. 
...
* **Industry Goal:** Applying advanced analytics and MLOps practices to solve complex financial and industrial problems.
...
![JAX](https://img.shields.io/badge/JAX-Hardware_Acceleration-000000?style=flat-square)
...
## 🔭 Selected Work & Teaching

### [Advanced Python for Time Series Analysis](https://luisgorozpe.github.io/py-ts-course/#/)
**Guest Technical Instructor | UNAM Institute of Economic Research**
* Designed and delivered a comprehensive workshop on deploying classical time series models.
* Focused on best practices using `statsmodels` and `pandas` for economic forecasting.
* [View Course Materials](https://luisgorozpe.github.io/py-ts-course/#/)
...
| :--- | :--- | :--- |
| **Data Fundamentals** | IBM SkillsBuild | 🟢 Active |
| **Data Science Foundations (Level 1)** | IBM SkillsBuild | 🟢 Active |
